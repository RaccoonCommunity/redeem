...
# set noninteractive to avoid prompts and reduce recommended packages
...
RUN apt-get update && apt-get install -y --no-install-recommends \
    ...
    libcups2 libdbus-1-3 libgdk-pixbuf-xlib-2.0-0 libnspr4 libnss3 libx11-xcb1 libxcomposite1 \
